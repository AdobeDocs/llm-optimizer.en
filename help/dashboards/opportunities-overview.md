...
|---------|----------|----------|----------|
| [Add LLM-friendly Summaries](/help/dashboards/opportunities/add-llm-friendly-summaries.md) | Content (Onsite) | Identifies long or complex pages that lack concise summaries at the page or section level, making them harder for AI to quickly scan and understand. Shows affected URLs and where summaries are recommended. | Review AI-generated page- or section-level summaries and deploy them at the CDN edge with Optimize at Edge so agents receive clearer, scannable context. |
