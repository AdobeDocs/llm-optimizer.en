...
description: Learn how LLM Optimizer analyzes your company's Wikipedia presence and provides recommendations to improve brand visibility in AI search results.
...
|---|---|
| Address press release tone issues | Critical |
| Add references to reach industry standard | Critical |
| Add products and services section | Critical |
| Add infobox | High |
| Enhance infobox with missing fields | High |
| Add company history section | High |
| Add content sections | High |
| Add leadership and management section | Medium |
| Add images to reach industry standard | Medium |
| Add categories to improve discoverability | Low |
| Article quality status | Informational |
...
![Your Article tab](/help/dashboards/opportunities/assets/wikipedia-analysis-your-article.png)
...
[View Wikipedia Analysis in the Frescopa demo](https://play.llmo.now/org/demo-org/opportunities/wikipedia-analysis/f4d0aa61-61e0-416f-a265-0cfddf17c3aa?siteId=frescopa-demo)
...
Wikipedia edits must be made directly on Wikipedia following their [editorial guidelines](https://en.wikipedia.org/wiki/Wikipedia:Editing_policy). LLM Optimizer provides the specific recommendations and data sources you need — the edits themselves are made on Wikipedia. If your article has been flagged for tone issues, review Wikipedia's [neutral point of view policy](https://en.wikipedia.org/wiki/Wikipedia:Neutral_point_of_view) before making changes.
...
The Wikipedia Analysis opportunity requires an existing Wikipedia article. If your brand does not have one, creating a Wikipedia page that meets Wikipedia's [notability guidelines](https://en.wikipedia.org/wiki/Wikipedia:Notability) is a foundational GEO step worth prioritizing before other optimizations.
