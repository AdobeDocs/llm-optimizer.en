...
>[!NOTE]
>By default, this dashboard builds traffic insights from **CDN logs**. If your organization is on a paid offer, you can connect to **Adobe Analytics** to add data that measures AI-driven discovery and site engagement. This data is available in the **Business Impact** tab. Without integration to Adobe Analytics the tab is not populated. See [Adobe Analytics integration](/help/dashboards/adobe-analytics-integration.md) for eligibility, ingested data and the connection procedure.
